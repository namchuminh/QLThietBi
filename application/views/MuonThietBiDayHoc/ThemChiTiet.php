...
<section class="content">
    <div class="container-fluid">
        <div class="block-header">
            <h2>MƯỢN THIẾT BỊ DẠY HỌC</h2>
        </div>
    	<div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="<?php echo base_url("muon-tra/them-chi-tiet/them/").$MaMuonThietBi; ?>" method="POST">
                    <div class="body">
                        <div class="row clearfix">
                        <div class="header">
                        <h2>
                    ...
                    <!-- <div class="row clearfix">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <input name="NgayHenTra" type="date" class="form-control date">
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
