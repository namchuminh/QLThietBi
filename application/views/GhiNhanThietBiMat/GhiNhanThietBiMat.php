    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <form action="<?php echo base_url("ghi-nhan-thiet-bi-mat/them-bao-mat"); ?>" method="POST">
                    <div class="header">
                        <a href="<?php echo base_url('ghi-nhan-thiet-bi-mat/'); ?>" class="btn btn-primary waves-effect m-r-20" >Quay Lại</a>
                    </div>
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-3">
                            ...
                            <div class="col-sm-3">
                                ...
                                <input disabled type="text" id="TenThietBi"class="form-control show-tick" tabindex="-98">
                            ...
                            <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input name="SoLuongMat" type="text" class="form-control" placeholder="Số lượng mất">
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                                <div class="form-group">
                                    <div class="form-line">
                                        ...
                                        <input name="LyDoMat" type="text" class="form-control" placeholder="Lý do mất">
                                    </div>
                                </div>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-primary waves-effect m-r-20" style="margin-top: -20px; float: right;">Báo mất</button>
                    <?php if(isset($error)){ ?>
