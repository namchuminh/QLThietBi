        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        <a href="<?php echo base_url('index/'); ?>" id="a-home">
                            <i class="material-icons">home</i>
                            <span>Trang Chủ</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="menu-toggle waves-effect waves-block" id="a-tb">
                            <i class="material-icons">widgets</i>
                            <span>Thiết Bị</span>
                        </a>
                        <ul class="ml-menu" id="ml-menu-tb">
                            <li>
                    ...
                    <a href="javascript:void(0);" id="a-mt" class="menu-toggle waves-effect waves-block" style="align-items: center;" >
                            <i class="material-icons">map</i>
                            <span>Mượn Trả</span>
                    </a>
                    <ul class="ml-menu" id="ml-menu-mt">
                        <li>
                    ...
                    <a href="javascript:void(0);" id="a-ht" class="menu-toggle waves-effect waves-block">
                          <i class="material-icons">assessment</i>
                        <span>Hệ Thống</span>
                    </a>
                    <ul class="ml-menu" id="ml-menu-ht">
                        <li>
                    ...
                    <a href="javascript:void(0);" id="a-bc" class="menu-toggle waves-effect waves-block">
                          <i class="material-icons">library_books</i>
                        <span>Báo cáo</span>
                    </a>
                    <ul class="ml-menu" id="ml-menu-bc">
                        <li>
